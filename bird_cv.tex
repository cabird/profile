...
\newcounter{reviewedpubs}
\setcounter{reviewedpubs}{23}

\begin{revnumerate}[\value{reviewedpubs}]
...
\newcounter{bookchapters}
\setcounter{bookchapters}{1}

\begin{revnumerate}[\value{bookchapters}]
...
\newcounter{miscpapers}
\setcounter{miscpapers}{3}

\begin{revnumerate}[\value{miscpapers}]
...
\textbf{Postdoctoral Researcher} \hfill \timespan{August, 2010 -- present}\\
\vspace{-10pt}
\begin{list1}
