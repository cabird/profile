...
\begin{list2}
\item ACM SigSoft Symposium on Foundations of Software Engineering, ``Learning Natural Coding Conventions'', 2014
\end{list2}
...
\showpaper{bird2015cfa}

\showpaper{bosu2015useful}

\showpaper{ray2015uniqueness}

\showpaper{zanjani2015developer}

\showpaper{smith2015homegrown}

\showpaper{barnett2015helping}

\showpaper{murphyhill2014design}

\showpaper{allamanis2014learning}

\showpaper{gupta2014energy}

\showpaper{phillips2014build}

\showpaper{muslu2014dvcs}

\showpaper{bird2014rac}
...
Lessons and Insights from Tech Transfers at Microsoft \hfill \timespan{October, 2014}\\
\vspace{-10pt}
\begin{list1}
\item Keynote, 4th Workshop on Mining Unstructured Data (colocated with ICSME 2015)
\item Victoria, Britich Columbia, Canada
\end{list1}

Investigations into Code Review at Microsoft and Beyond \hfill \timespan{November, 2013}\\
\vspace{-10pt}
\begin{list1}
